...
theme: PMA.UI.View.Themes.Modern
    ...
    $("#snapshot-btn").on("click", function () {
        ...
        slideLoader.mainViewport.getSnapshot(format, snapshotOptions)
            .then(function (data) {
                console.log(data);
            })
    });
    ...
    $("#inputFlipHor").on("change", function () {
        // Flip horizontally
        slideLoader.mainViewport.setFlip($("#inputFlipHor").is(':checked'), $("#inputFlipVer").is(':checked'));
