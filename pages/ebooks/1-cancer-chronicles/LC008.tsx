...
const Article = () => {
  return (
    <PageLayout blogcentered>
      <Image src="/public/images_histo/8.png" size={ImageSize.SMALL} alt="" />
      <LinkTo
        href="https://histopathology-viewer.vercel.app/viewer8.html"
        passHref
      ...
      <Text p>
        A 55-year-old patient diagnosed with lung cancer and their loved ones
      ...
      <Text p>
        This case study offers an intimate portrayal of a 55-year-old patient
