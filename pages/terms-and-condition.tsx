  ...
  return (
    <PageLayout PAGE_SEO={PAGE_SEO} home>
      <div className="container px-3 pb-[20px] mt-10 pt-14 md:pt-0">
        ...
        <Text p>
          Welcome to [Website_Name]! <br />
          <br />
          These terms and conditions outline the rules and regulations for the
          use of [Company_Name]'s Website, located at [Website_URL]. <br />
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use [Website_Name] if you do not agree
        ...
        <Text p>
          We employ the use of cookies. By accessing [Website_Name], you agreed
          to use cookies in agreement with the [Company_Name]'s Privacy Policy.{" "}
          <br />
        ...
        <Text p>
          Unless otherwise stated, [Company_Name] and/or its licensors own the
          intellectual property rights for all material on [Website_Name]. All
          intellectual property rights are reserved. You may access this from
          [Website_Name] for your own personal use subjected to restrictions set
        ...
        <Text p>
          ...
          [Company_Name] does not filter, edit, publish or review Comments prior
          to their presence on the website. Comments do not reflect the views
          and opinions of [Company_Name],its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, [Company_Name]
          ...
          [Company_Name] reserves the right to monitor all Comments and to
        ...
        <Text p>
          You hereby grant [Company_Name] a non-exclusive license to use,
        ...
        <Text p>
          ...
          the hyperlink compensates the absence of [Company_Name]; and (d) the
          ...
          sending an e-mail to [Company_Name]. Please include your name, your
