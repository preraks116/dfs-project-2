  ...
  return (
    <PageLayout PAGE_SEO={PAGE_SEO} home>
      <div className="container px-3 pb-[20px] mt-10 pt-14 md:pt-0">
        ...
        <Text p>
          At [Website_Name], accessible from [Website_URL], one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by [Website_Name] and how we use it. <br />
          If you have additional questions or require more information about our
          Privacy Policy, do not hesitate to contact us. <br />
          This Privacy Policy applies only to our online activities and is valid
          for visitors to our website with regards to the information that they
          shared and/or collect in [Website_Name]. This policy is not applicable
          to any information collected offline or via channels other than this
          website. Our Privacy Policy was created with the help of the Privacy
          Policy Generator.
        </Text>
        <Seperator line />
        ...
        <Text p>
          [Website_Name] follows a standard procedure of using log files. These
        ...
        <Text p>
          Like any other website, [Website_Name] uses 'cookies'. These cookies
        ...
        <Text p>
          ...
          advertising partners of [Website_Name]. <br />
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on [Website_Name], which are sent
          directly to users' browser. They automatically receive your IP address
          when this occurs. These technologies are used to measure the
          effectiveness of their advertising campaigns and/or to personalize the
          advertising content that you see on websites that you visit. <br />
          Note that [Website_Name] has no access to or control over these
        ...
        <Text p>
          [Website_Name]'s Privacy Policy does not apply to other advertisers or
          websites. Thus, we are advising you to consult the respective Privacy
          Policies of these third-party ad servers for more detailed
          information. It may include their practices and instructions about how
          to opt-out of certain options. <br />
        ...
        <Text p>
          ...
          right to: <br /> Request that a business that collects a consumer's
        ...
        <Text p>
          ...
          [Website_Name] does not knowingly collect any Personal Identifiable
