    ...
    <PageLayout home>
      <div className="container px-3 pb-[20px] md:mt-[50px] pt-20 md:pt-0">
        ...
        <div className="dark:bg-slate-800 bg-blue-200 mt-5 rounded px-3 py-2">
          <i>*note: All the files you will create or interact with are in</i>
          <List type={ListType.disc} className="mt-5">
            <li>
              <b>BLOG_CONSTANTS folder : </b> inside this we have our
              _BLOG_SETUP.tsx file where we set our authors, navbar and other
              details and we have _ARTICLES_LIST.tsx file where we maintain our
              article list.
            </li>
            <li>
              <b>blog folder : </b> Inside this we will create out blog files or
              sub folders for your article files like this current file is in{" "}
              {"pages -> blog -> tutorial"}
            </li>
            <li>
              <b>images folder : </b> In this we will save all our images to use
              in the articles, like the og-image.jpg file is stored in{" "}
        ...
        <List type={ListType.disc} className="mt-5">
          ...
          <li>
            <Text p className="mt-2">
              ...
              image below. <br />
              <i>
                <b>*note : </b> adding featureArticle property is optional
              </i>
            </Text>
            <Image
              className="my-5"
          ...
          <li>
            ...
            <List type={ListType.disc} className="mt-3">
              <li>
                <b>author : </b>
                Paste the author variable imported from _BLOG_SETUP as shown in
                the image.
              </li>
              <li>
                <b>date : </b>
              ...
              <li>
                <b>thumbnail : </b>
                Save the image file in public-images folder and paste the image
                path. This will be displayed in article cards on home page. For
                thumpbails the recommended size is <b>540x300px</b>.
              </li>
              <li>
                <b>shortIntro : </b>A short intro for your article that will be
                shown on article cards.
              </li>
              <li>
                <b>category : </b>
            ...
            <b>/BLOG_CONSTANTS/_ARTICLES_LIST.tsx</b> file.
          </li>
          <li>
            <b>seo</b>
            <br />
