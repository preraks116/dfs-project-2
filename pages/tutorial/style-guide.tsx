    ...
    <PageLayout>
      <section className="container md:pt-10 pt-20">
        ...
        <div className="px-4 py-3 dark:bg-slate-800 bg-blue-200 rounded my-5">
          ...
          for this project so we can use all the css classes and styles given in
          the{" "}
          <LinkTo href="https://tailwindcss.com/docs/font-size" external>
            <b> tailwind css docs</b>
          </LinkTo>
          . You can have an extensive tutorial of all utility classes in the
        ...
        For background color follow the guide given{" "}
        <LinkTo
        ...
        . <br />
        For background image use the syntax{" "}
        <b>{`className="bg-[url('/public/images/tutorials/demo-image.jpg)]"`}</b>
        . For more info follow the guide given{" "}
        <LinkTo
          href="https://tailwindcss.com/docs/background-image#arbitrary-values"
          external
          className="underline"
        >
          here
        ...
        We have a setup for dark and light mode by default. You can see the
        styling doc on how to change your styles with respect to light or dark
        theme{" "}
        <LinkTo
        ...
        For different screen sizes we can give different stylings or classes
        with the help of some breakpoint identifiers or prefixes namely{" "}
        <b>sm, md, lg, xl, 2xl</b>. <br />
        We will be majorly using{" "}
        <b>md: for medium screen devices like tablets</b> and{" "}
        <b>lg: for large screen devices like laptops and desktops</b>. <br />
        <br />
        <b>Example</b>: lets say we want to give a text font size of 14px in
        mobile devices, 18px in medium sceen devices and 28px for large devices,
        our className will look like this{" "}
        ...
        <div className="px-4 py-3 dark:bg-slate-800 bg-blue-200 rounded my-5">
          ...
          have any issues or queries please feel free to write us at{" "}
          <u>webexpe13@gmail.com</u> or drop a comment on our github discussions{" "}
          <a
            href="https://github.com/webexpe13/blog-template-using-nextjs-typescript-tailwindcss/discussions"
            target="_blank"
            rel="noopener noreferrer"
          >
            <u>github.com/nmayur/nextjs-simple-blog-template/discussions</u>
          </a>
          .
        </div>
      </section>
