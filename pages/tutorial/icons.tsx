    ...
    <PageLayout PAGE_SEO={PAGE_SEO} home>
      <div className="container pb-5 md:mt-[50px] pt-20 md:pt-0">
        ...
        <p className="my-5">
          We have used{" "}
          <b>
            <LinkTo href="https://react-icons.github.io/react-icons">
              ReactIcons
            </LinkTo>
          </b>{" "}
        ...
        <b>"Ant design icons, Bootstrap icons, Boxicons . . ."</b> etc. When you
        click on the sidebar list button we se a proper import statement and
        list of all icons in the icon group.
        <Image
          src="/public/imp_assets/tutorials/reacticons.png"
          alt="webexpe.com"
          caption="ReactIcons website screenshot"
        />
        here we can see each icons in <b>BoxIcons</b> there is a <b>"Bi"</b>{" "}
        prefix i.e each icon in <b>BoxIcons</b> start with a <b>"Bi"</b> like{" "}
        <b>"BiAbacus, BiAdjust . . ."</b> etc. so when want to use any icon from
        BoxIcons you have to import the icon as{" "}
        ...
        <b>Note* :</b> when you search any icon using the search option in react
        icons, all the icons from different groups will be displayed mixed so to
        know from where to import the icons see the first 2 letters of the icon
        name then import that icon group.
