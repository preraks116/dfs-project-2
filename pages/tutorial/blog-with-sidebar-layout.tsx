...
const Article = () => {
  ...
  return (
    ...
    export default Article;
        ...
        className="my-5"
      />
      The above code snippet gives you a demo on how to use blogwithsidebar
      layout. The current article that you see is the basic output/example of
      blogwithsidebar layout which will consist of a navbar on the top, a side
      bar and the main content area. The side bar will content author details
      and more articles by the author.
      {/* </Text> */}
      ...
      <Text p>
        ...
        <br />
        <u>blog-with-sidebar-layout.tsx</u> file inside <u>pages/tutorial</u>{" "}
        folder.
      </Text>
      <Text subtitle className="mt-10 md:text">
        Features
      ...
      <List type={ListType.disc}>
        <li>
          This layout is of contained width i.e has a max width same as the
          navbar, this is to keep the article / blog posts style consistent.
        </li>
        <li>
          In the sidebar on the right, we have author details and more articles
          from the author.
        </li>
        <li>
      ...
      <Text p>
        Check <u>blog-with-sidebar-layout.tsx</u> in <u>pages/tutorial</u> file
        to see all the mentioned components in use.
      </Text>
      <List>
        <li>
          We have used the <b>{"<PageLayout blogwithsidebar>"}</b> as shown in
          the above code block.
        </li>
        <li>
          <b>{"Image"}</b> tag for displaying images. <br /> To use image we
          have to import <b>Image</b> from components and <b>ImageSize</b> enum
          from enums. The Image size will help us to set the size of the image.{" "}
          <br /> Available sizes:{" "}
          <b>
            ImageSize.DEFAULT, ImageSize.FULL, ImageSize.MEDIUM,
            ImageSize.SMALL, ImageSize.XS
          </b>
          .
          <CodeBlock code={HowToUseImageCode} className="my-5" />
        </li>
        <li>
          <b>{"Text"}</b>. <br /> We use this to write content/text. To use
          image we have to import <b>Text</b> from components. We have different
          Text types like <b>title, subtitle, p, quote</b> with default styles
          and by default it is of type paragraph.
          <CodeBlock code={HowToUseTextCode} className="my-5" />
        </li>
        <li>
          <b>{"List"}</b> <br />
          This is used to display lists. We have 3 different types:{" "}
          <b>ListType.disc | ListType.number | ListType.none</b>, by default it
          is of type ListType.disc.
      ...
      <Text p>
        <b>note:</b> all these components are used in{" "}
        <u>blog-with-sidebar-layout.tsx</u> and{" "}
        <u>blog-with-centerd-layout.tsx</u> in <u>pages/tutorial</u>. You can
        also check{" "}
        <b>
