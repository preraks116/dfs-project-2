...
const HomeLayoutExample = () => {
  return (
    <PageLayout home>
      <section className={"container pt-20 md:pt-10"}>
        ...
        <Text p>
          ...
          ,
          <LinkTo href="/pages/about-us.tsx" passHref>
            {" "}
            About
          </LinkTo>
          ,
          <LinkTo href="/pages/tutorial/icons.tsx" passHref>
            {" "}
            Icons
          </LinkTo>
          ,
          <LinkTo href="/pages/privacy-policy.tsx" passHref>
            {" "}
            Privacy Policy
          </LinkTo>
          ,
          <LinkTo href="/pages/terms-and-condition.tsx" passHref>
            {" "}
            Terms & Conditions{" "}
          </LinkTo>{" "}
          pages.
    ...
    export default Article;
        ...
        />
        <Text p>
          The above code block gives you a demo on how to use the layout. If you
          want to see this in action check this article file <br />
      ...
      <section>
        <div className="container px-3">
          ...
          <Text p>
            This layout is full width, you can create full width sections using
            this layout.
          </Text>
        </div>
        <div className="bg-slate-300 dark:bg-slate-700 py-5">
          <div className="container text-2xl">Full width section example.</div>
        </div>
      </section>
      <div className="container px-3">
