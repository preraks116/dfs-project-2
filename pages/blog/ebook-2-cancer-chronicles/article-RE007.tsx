...
const Article = () => {
  return (
    <PageLayout blogcentered>
      <Image src="/public/images_histo/7.png" size={ImageSize.SMALL} alt="" />
      <LinkTo
      ...
      <Text p>
        ...
        research. The featured nature of this article signifies its significance
        in contributing valuable knowledge to the field of cancer care and
        research.
      </Text>
    </PageLayout>
  );
